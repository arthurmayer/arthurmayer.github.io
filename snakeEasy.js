...
window.onkeydown = function (e) {
    ...
    switch (key) {
        case "ArrowLeft":
        case 37:
            if (snake.direction != 'right' && agility) {
        ...
        case "ArrowUp":
        case 38:
            if (snake.direction != 'down' && agility) {
                snake.direction = 'up';
                agility = false;
            }
            break;
        case "ArrowRight":
        case 39:
            if (snake.direction != 'left' && agility) {
    ...
    if (!paused && gameStart) {
        if (gameLost) {
            ...
            setTimeout(function () {
                if (newHighscore) {
                    newHighscore = false;
                    setName(scoreName = window.prompt("Enter a name for the highscore", localStorage.getItem("SnakeName").toString()).toString());
                }
                if (playerScore < 5) {
...
if (!localStorage.getItem("SnakeName")) {
    ...
    setName(localStorage.getItem("SnakeName").toString());
}
reset();
